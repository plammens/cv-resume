...
\begin{twocol}
     ...
     \cvchronoitem{Analysing and visualising chord sequences in music}
                  ...
                  Link: \www{community.wolfram.com/groups/-/m/t/1383630}}
      \smallskip
      \cvchronoitem{PySimplex}
      {}
      {November 2018}{}{archived}
      {Simple Python implementation of the primal simplex algorithm in linear optimization. Based on university coursework from the Mathematical Programming course. Link: \www{github.com/plammens/PySimplex}}
