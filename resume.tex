...
\aboutme{
Mathematics \& Computer Science student with attested interest in software development, music, and machine learning.}%About me section
...
\begin{twenty}[\chronowidth]
  \twentyitem
    {\noindent Sep 2019 - \\ present \\(exp. 2022)}
    {\large BSc (Hon.) Mathematics \& Computing Science}
    {{} \newline University of Glasgow}
    {Entered at Level 2. Activities \& Societies: HackerOlympics 2019, Chapel Choir, Kelvin Ensemble (First Year Representative). \textit{GPA: 19 (out of 22)}}
  \twentyitem
    {Sep 2018 -  \\Jun 2019}
